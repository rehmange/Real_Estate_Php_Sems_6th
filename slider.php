<!-- <div class="slider" id="slider" style="--img-prev:url(https://lh3.googleusercontent.com/aC9nyW5dhaYFmWD8fcf8DApjpH08eHEkbCHqmUPHRQ5T3jK-QyNKZYVMehmrvyPdEA_KxWvgZ3_kyOOYOAv99Ow3UoKSvEloleVKGSfLOwOyDV3Q6Dwi1G-NYoa9-t_ofmmskE6BYnVIOnIz2HWlMcijzIEwvKAL_R4z63DaLgG0z_OcGiSQHunwGAPXrBQUv42ZXuIMODq4zxDHczSxJ72b0-_udtdQK3JuT2X8nXCwFoF7GxmOpzXS0H5f50DuCbXoXcx-O7bgBMCXZdMpTxB27-wdXeLmxpYUySXgjSN2NAKmK16DmGLYvw5tMlrqwb8h4MJEEbXjP1pjPxXsahb7UZseEGyn80uLjATANJvusyJWCtzkkxYXPz-yI1rDvfEJKe2eyA-5AvFlzFBSwBMASn8f7mXinUrXMMREkJQjoi89NfZ91G7253OEVQOqcWxddiYtcHCO5v6Pl3QfV2SUTWXgggscDSY2ezjSPpYERNTXnIM_aCyWmIG7ybrfqOB0eVYBAgynyuPVbjd4KuZWZq2Dfu33HX1RuPKglbOuZGD1QbpJnruvUVkAmjDXI40ENN7X=w1600-h766);"> 
  <div class="slider__content" id="slider-content">
    <div class="slider__images">
      <div class="slider__images-item slider__images-item--active" data-id="1"><img src="picture/slider/1.jpg"/></div>
      <div class="slider__images-item" data-id="2"><img src="picture/slider/2.jpg"/></div>
      <div class="slider__images-item" data-id="3"><img src="picture/slider/3.jpg"/></div>
      <div class="slider__images-item" data-id="4"><img src="picture/slider/4.jpg"/></div>
      <div class="slider__images-item" data-id="5"><img src="picture/slider/5.jpg"/></div>
    </div>
    <div class="slider__text">
      <div class="slider__text-item slider__text-item--active" data-id="1">
        ...
        <div class="slider__text-item-info">
          <p>“Fly to the heart of London from Edinburgh, Dublin, Zurich, Amsterdam”</p>
        </div>
      </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="picture/slider/1.jpg?auto=yes&bg=777&fg=555&text=First slide" style="height:37rem" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="picture/slider/2.jpg?auto=yes&bg=666&fg=444&text=Second slide" style="height:37rem"  alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="picture/slider/3.jpg?auto=yes&bg=555&fg=333&text=Third slide" style="height:37rem"  alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="picture/slider/4.jpg?auto=yes&bg=555&fg=333&text=Third slide" style="height:37rem"  alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="picture/slider/5.jpg?auto=yes&bg=555&fg=333&text=Third slide" style="height:37rem"  alt="Third slide">
    </div>
